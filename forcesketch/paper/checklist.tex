...
\item {\bf AI / LLM disclosure} \emph{(important)}
    ...
    \item[] Answer: \answerYes{}
    \item[] Justification: Claude was used throughout: writing the estimator library and analysis code, running the experiments and minor formatting work on the manuscript.The author set the research question and the experimental design, checked the results against the raw records, and is responsible for the content.
