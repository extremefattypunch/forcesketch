...
> Ian Poon, Department of Cellular and Molecular Biology, Harvard University
...
LLM-based coding agents were used substantially: research ideation, experiment and
...
`results/REVIEW_FINDINGS.md` records where agent-written work did fail, including
two critical defects: a benchmark that silently measured seven lanes where it
reported eight, and a filename collision that destroyed a result file.
